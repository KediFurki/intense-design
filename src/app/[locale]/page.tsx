      ...
      <section className="relative overflow-hidden bg-stone-900 text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 py-28 text-center sm:px-6 md:py-36">
          ...
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Link href="/category/all"><Button size="lg" className="cursor-pointer rounded-full bg-stone-100 px-8 py-6 text-lg text-stone-900 hover:bg-stone-200">{t("experience3D")}</Button></Link>
            ...
            <Link href="/about"><Button size="lg" variant="outline" className="cursor-pointer rounded-full border-stone-200 bg-transparent px-8 py-6 text-lg text-white hover:bg-stone-100 hover:text-stone-900">{t("meetUs")}</Button></Link>
          </div>
        </div>
      </section>
